 ...
 *  - PC 788×492 / WISE 380×456 单屏交付（no-scroll-frame, overflow:hidden）
 ...
 *
 * 当前 v0.4 阶段只覆盖 dtp_dynamic_encyclopedia_summary_card。
 * 后续 Stage 6 收尾时补齐 timeline / relation / compare / expandable。
 */
...
<html lang="zh-CN">
  <head>
    ...
    <style>
      ...
      body { font-family: "PingFang SC", "Microsoft YaHei", system-ui, sans-serif; color: #1E1F24; background: #F8F8F8; }
...
export const officialDesignTemplatePacks: DesignTemplatePack[] = [
  ...
  },
  {
    ...
    rationale: {
      overview: 'Use this as a template package for dynamic encyclopedia entry cards. It produces a single-screen deliverable (PC 788x492 / WISE 380x456) with no internal scrolling. Content that exceeds the canvas must be split across tab bars, paginated page switchers, or modal dialogs.',
      ...
      typography: 'Default body language is Simplified Chinese. Entries classified as language-category (foreign language / linguistics / translation / dialect) may use the source language but must keep typography consistent. Content must stay legible at 300px width. Prefer short labels, dense facts, and restrained hierarchy.',
      layout: 'PC must render perfectly at 788x492. Mobile standard is 380x456. Also tolerate 396x475 and 300x360 with only minor imperfections. Preserve width:height ratio near 1:1.2 on mobile. No body scrolling, no container scrolling — content overflow is handled by tabs, page switchers, or modals.',
      ...
      components: 'Expected subtemplates include entity summary card, fact timeline, media-light gallery, relation graph preview, Q&A fact list, and expandable detail sections. Tab/page-switcher/modal components replace the legacy .scroll-container.',
      dos: [
  ...
  },
  {
    ...
    visibility: 'public',
    status: 'published',
    name: 'Dynamic Encyclopedia · Historical Person Relationship',
    description: 'A vertical child template for historical-person relationship maps, kinship, factions, mentorship, rivals, and cross-person navigation.',
    version: '1.0.0',
    designTokens: {
      colors: {
        primary: '#6487FA',
  ...
  },
  {
    ...
    visibility: 'public',
    status: 'published',
    name: 'Dynamic Encyclopedia · Historical Person Event Chain',
    description: 'A vertical child template for historical-person event causality, life-stage timelines, reforms, battles, and cultural events.',
    version: '1.0.0',
    designTokens: {
      colors: {
        primary: '#6487FA',
  ...
  },
  {
    ...
    visibility: 'public',
    status: 'published',
    name: 'Dynamic Encyclopedia · Film Cast Role Network',
    description: 'A vertical child template for film actor-role mapping, director-actor cooperation, roles, and cross-work discovery.',
    version: '1.0.0',
    designTokens: {
      colors: {
        primary: '#6487FA',
  ...
  },
  {
    ...
    visibility: 'public',
    status: 'published',
    name: 'Dynamic Encyclopedia · Film Series Navigation',
    description: 'A vertical child template for film series, prequels, sequels, remakes, IP derivatives, and similar-film discovery.',
    version: '1.0.0',
    designTokens: {
      colors: {
        primary: '#6487FA',
  ...
  },
  {
    ...
    visibility: 'public',
    status: 'published',
    name: 'Dynamic Encyclopedia · TV Character Relation',
    description: 'A vertical child template for TV character relationships, factions, family, workplace, emotion, and role quick answers.',
    version: '1.0.0',
    designTokens: {
      colors: {
        primary: '#6487FA',
  ...
  },
  {
    ...
    visibility: 'public',
    status: 'published',
    name: 'Dynamic Encyclopedia · TV Episode Chain',
    description: 'A vertical child template for TV episode plot chains, clue causality, foreshadowing, and episode-state exploration.',
    version: '1.0.0',
    designTokens: {
      colors: {
        primary: '#6487FA',
  ...
  },
  {
    ...
    visibility: 'public',
    status: 'published',
    name: 'Dynamic Encyclopedia · Cultural Phrase Relation Graph',
    description: 'A vertical child template for idiom, cultural phrase, synonym, antonym, same-source, story-related, and confusing-word relations.',
    version: '1.0.0',
    designTokens: {
      colors: {
        primary: '#6487FA',
  ...
  },
  {
    ...
    visibility: 'public',
    status: 'published',
    name: 'Dynamic Encyclopedia · Cultural Phrase Origin Story',
    description: 'A vertical child template for idiom origin, source text, story cause-process-result, figures, events, and cultural meaning.',
    version: '1.0.0',
    designTokens: {
      colors: {
        primary: '#6487FA',
