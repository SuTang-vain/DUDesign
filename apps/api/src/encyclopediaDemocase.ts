...
const democases: EncyclopediaDemocase[] = [
  ...
  },
  {
    ...
    interactionParadigmId: 'ip_entity_summary',
    preferredTemplateIds: ['dtp_dynamic_encyclopedia_summary_card'],
    keywords: ['概念', '定义', '理论', '技术', '算法', '模型', '协议'],
    summary: '知识术语词条优先展示定义、适用范围、关键要点和辨析信息。',
  },
  {
