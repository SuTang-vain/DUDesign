        ...
        return {
          ...
          variations: variations
            ...
            .map(variation => ({
              ...
              runtimeBackendId: variation.runtimeBackendId,
              runtimeLeaseId: variation.runtimeLeaseId,
              runtimeChildSessionId: variation.runtimeChildSessionId,
              runtimeAgentJobId: variation.runtimeAgentJobId,
              runtimeAttempt: variation.runtimeAttempt,
              runtimeLastErrorCode: variation.runtimeLastErrorCode,
