...
> 目标：把领域模板、审美偏好、插件能力和自动化 loop 组合成可治理、可复用、可审计的设计生成能力
...
| 关联层 | 职责 |
| --- | --- |
| 用户前端交互层 | 领域模板选择、审美/颜色偏好选择、插件/skill 选择、自动化强度选择、我的模板 |
...
模板回答“用户要做什么领域的网站，以及希望呈现什么审美”。

模板分为两个层次：

- 领域模板：创意与艺术、金融科技、专业企业、汽车、Apple 风、品牌/IP 风格等。
- 审美偏好：颜色方案、视觉气质、排版密度、品牌表达、情绪方向等。
...
```text
Domain Template + Aesthetic Profile
        ↓
...
用于存领域模板、审美 profile、颜色方案和用户自定义模板。
...
用于存用户默认领域模板、审美偏好、默认 skill、授权插件和 loop 强度。
